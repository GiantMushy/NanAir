...
class EmployeeDataEditUI:
    ...
    def employee_data_edit_output(self):
        ...
        self.PrintUi.print_header(
            "Employee Database Menu > View/Edit > " + self.PrintUi.auto_shorten_name(self.employee['name'], 50), "left")
        ...
        print(self.PrintUi.allign_left(
            f"    Name                  {self.PrintUi.auto_shorten_name(self.employee['name'],50)}"))
        print(self.PrintUi.allign_left(
        ...
        print(self.PrintUi.allign_left(
            f"3 : Email                 {self.PrintUi.auto_shorten_name(self.employee['email_address'],50)}"))
        print(self.PrintUi.allign_left(
    ...
    def edit_data(self, changed_data):
        ...
        print(self.PrintUi.allign_left(
            f"    Email                 {self.PrintUi.auto_shorten_name(self.employee['email_address'],50)}"))
        print(self.PrintUi.allign_left(
